...
% This part, in a sense, is a learning process where I familiarized myself with the lengthy code and complicated code organization in the \href{https://github.com/eth-ait/cose/tree/master}{github repository that stores CoSE model} and also deciding on how to adopting this model in my proposed study. To demonstrate the process of mocked-up analysis, I also include relevant code to more clearly demonstrate the operating principle behind.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth, keepaspectratio]{Weekly_assignments/Figures for mocked-up results/my_sample_drawing.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.7]{Weekly_assignments/Figures for mocked-up results/Entropy and Bhattacharyya Distance Measures per Number of Input Strokes.png}
