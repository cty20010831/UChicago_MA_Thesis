...
### Results
Mood induction successfully altered participants’ arousal and valence levels, but it did not yield significant differences in creativity metrics across mood conditions. However, deeper analysis uncovered two distinct modes of cognitive flexibility:
- Persistent exploratory breadth, measured by average entropy and Bhattacharyya distance
- Adaptive switching, captured through inflection-based drawing metrics and semantic flexibility (DSI)

Only the adaptive switching mode of flexibility was significantly associated with higher originality, as measured by AuDrA. These findings suggest that the key to generating original ideas lies not in maintaining a broad range of possibilities, but in the ability to dynamically shift strategies and integrate conceptually distant ideas in real time.
