...
This respostory mainly contains the Latex code (and reference .bib file) for my MA thesis at UChicago. It extends from the [repository](https://github.com/UC-MACS-30200/course-project-cty20010831) I used for the MACS 30200 course I took during the spring quarter, 2024. In that course, I wrote the proposal for the research project (titled "The Art of Positivity in Drawing: Unveiling the Impact of Positive Mood States on Visual Creativity via Deep Learning"), which is now extended to the final MA thesis.
